...
type TestOptions = 
  ...
  , opaqueOpt     :: Opaque { opaque1 :: String , opaque2 :: Maybe Number}
  }
...
defaultOpts = 
  ...
  , opaqueOpt : Opaque { opaque1 : "opaque1" , opaque2 : Just 12345}
  -- ^ Any value wrapped in Opaque is protected from the conversion rules.
  } :: TestOptions
